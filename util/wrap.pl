...
BEGIN {
    ...
    require '/home/scnu511/ryanclq/openssl-openssl-3.1.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/scnu511/ryanclq/openssl-openssl-3.1.0/test/fips-and-base.cnf';
    shift;
